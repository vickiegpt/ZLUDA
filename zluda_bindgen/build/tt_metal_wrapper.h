...
// NOC enumeration
typedef enum { tt_NOC_RISCV_0_default = 0, tt_NOC_RISCV_1_default = 1 } tt_NOC;
...
typedef enum {
  tt_Result_Success = 0,
  tt_Result_Error_InvalidArgument = 1,
  tt_Result_Error_OutOfMemory = 2,
  tt_Result_Error_DeviceError = 3,
  tt_Result_Error_CompilationFailed = 4,
  tt_Result_Error_RuntimeError = 5,
  tt_Result_Error_NotSupported = 6,
  tt_Result_Error_NotImplemented = 7,
  tt_Result_Error_Unknown = 999
} tt_Result;

// Event status enumeration
typedef enum {
  tt_EventStatus_Complete = 0,
  tt_EventStatus_Incomplete = 1,
  tt_EventStatus_Error = 2
} tt_EventStatus;
